...
function aboutMePageText() {
  return (
    <div className="aboutText">
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Concevoir le Back end et les Api <span>NodeJs Express</span><br/><br/>
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;- Concevoir le Front end en <span>ReactJs HTML/CSS SASS JS</span><br/><br/>
...
export default aboutMePageText